    ...
    <header>
        <nav class="navbar navbar-expand-lg" id="nav">
            <div class="container-fluid">
                ...
                <img src="img/banner_Nostro.png" alt="banner Colégio Nostro" class="col-5">
                <a class="navbar-nav mx-5 px-4 py-2" href="index.html" id="botaoRetorno">Retornar</a>
            </div>
        </nav>
    </header>
                ...
                <div class="row g-0 align-items-center">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <div class="text-end">
                                <a href="PagLogin.php" id="linkLogin"><button class="btn px-4 py-2" id="botao">Acessar</button></a>
                            </div>
                        </div>
                    </div>
                </div>
